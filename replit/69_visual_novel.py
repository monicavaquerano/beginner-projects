...
start = tk.PhotoImage(file="image1.png")
start = start.subsample(4)
codes = tk.PhotoImage(file="image1.png")
codes = codes.subsample(4)
replit = tk.PhotoImage(file="image1.png")
replit = replit.subsample(4)
days = tk.PhotoImage(file="image1.png")
days = days.subsample(4)
amazing = tk.PhotoImage(file="image1.png")
amazing = amazing.subsample(4)
vs = tk.PhotoImage(file="image1.png")
vs = vs.subsample(4)
...
button6 = tk.Button(
    text="You say 'Im actually going through 100 days of code right now", command=iWin
)
